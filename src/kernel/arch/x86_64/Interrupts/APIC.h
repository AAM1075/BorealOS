...
namespace Interrupts {
    ...
    public:
        explicit APIC(Core::Firmware::ACPI* acpi, Core::CPU* cpu, PIC* pic, Memory::Paging* paging, IDT* idt, Core::Time::HPET* hpet);
        ...
        static constexpr uint32_t CURRENT_COUNT_REG_OFFSET  = 0x390;
        ...
        [[nodiscard]] uint8_t GetLAPICID() const { return _LAPICID; }
